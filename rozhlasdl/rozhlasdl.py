...
def create_parser():
    ...
    parser.add_argument('-n', '--no-duplicates', help='No duplicates are kept',
                        dest="no_duplicates", default=True, action='store_true')
    return parser
...
def main():
    ...
    no_duplicates = parser.parse_args().no_duplicates
